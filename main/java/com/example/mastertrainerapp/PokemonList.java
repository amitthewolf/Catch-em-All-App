...
import com.example.mastertrainerapp.Adapter.PokemonListAdapter;
import com.example.mastertrainerapp.Common.Common;
import com.example.mastertrainerapp.Common.ItemOffsetDecoration;
import com.example.mastertrainerapp.Model.Pokedex;
import com.example.mastertrainerapp.Retrofit.IPokemonDex;
import com.example.mastertrainerapp.Retrofit.RetrofitClient;
    ...
    private void fetchData() {
        compositeDisposable.add(iPokemonDex.getListPokemon().subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<Pokedex>() {
            ...
            public void accept(Pokedex pokedex) throws Exception {
                Common.commonPokemonList = pokedex.getPokedex();
                PokemonListAdapter adapter = new PokemonListAdapter(getActivity(),Common.getList());
